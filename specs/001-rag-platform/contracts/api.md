...
Ingests a public product documentation document, triggering chunking and embedding. If `source_url` is a ReadMe URL (e.g., `https://reap.readme.io/docs/slug`), the system will automatically fetch the content via the ReadMe API.
...
```json
{
  ...
  "content": "Full markdown or text content here... (Optional if source_url is a supported API like ReadMe)",
  "version": "v1.2.0",
  "metadata": {}
}
```
