...
export class AddExternalIdToDocument1780834188603 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "documentation_documents" ADD "external_id" character varying`);
        await queryRunner.query(`ALTER TABLE "business_knowledge_entries" DROP COLUMN "embedding"`);
        await queryRunner.query(`ALTER TABLE "business_knowledge_entries" ADD "embedding" vector(192) NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "business_knowledge_entries" DROP COLUMN "embedding"`);
        await queryRunner.query(`ALTER TABLE "business_knowledge_entries" ADD "embedding" vector(768) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "documentation_documents" DROP COLUMN "external_id"`);
