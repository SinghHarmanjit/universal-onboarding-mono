...
export class AddPgvectorIndexes1780837009000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "idx_docs_chunk_embedding" ON "documentation_chunks" USING hnsw ("embedding" vector_cosine_ops)`);
        await queryRunner.query(`CREATE INDEX "idx_business_knowledge_embedding" ON "business_knowledge_entries" USING hnsw ("embedding" vector_cosine_ops)`);
    }
